...
data <- read_csv("~/Documents/Cognitive Science/Kandidat/1_Semester/NLP/Exam Project/NLP_Project/4_Sentiment_analysis/zalando_sentiment_NEWEST.csv")
...
write.csv(data, file = "data_sentiment.csv")
```
...
data <- read_csv("~/Documents/Cognitive Science/Kandidat/1_Semester/NLP/Exam Project/NLP_Project/4_Sentiment_analysis/zalando_sentiment_encoded.csv")
