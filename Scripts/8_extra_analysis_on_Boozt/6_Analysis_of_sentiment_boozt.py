...
data = pd.read_csv("boozt_sentiment.csv")
...
#data2019 = data[data.year == 2019]      # Shape: 4590
#data2018 = data[data.year == 2018]      # Shape: 0
#data2012_17 = data[data.year < 2018]    # Shape: 0
...
# Money
#==========
money = data[data.money_related == 1] # 1152 sentences
money.shape
...
# Delivery
#==========
delivery = data[data.delivery_service == 1] # 792 sentences
delivery.shape
...
# Return
#==========
returning = data[data.return_service == 1] # 945 sentences
returning.shape
...
# Products
#==========
products = data[data.products == 1] # 1071 sentences
products.shape
...
# Service
#==========
service = data[data.customer_service == 1] # 1959 sentences
service.shape
...
# Brand
#==========
brand = data[data.brand == 1] # 1387 sentences 
brand.shape
...
#=======================================================
sentences_neg = [money_neg["sent_toke_senti"],
                delivery_neg["sent_toke_senti"],
                returning_neg["sent_toke_senti"],
                products_neg["sent_toke_senti"],
                service_neg["sent_toke_senti"],
                brand_neg["sent_toke_senti"],
                ]

sentences_pos = [money_pos["sent_toke_senti"],
                delivery_pos["sent_toke_senti"],
                returning_pos["sent_toke_senti"],
                products_pos["sent_toke_senti"],
                service_pos["sent_toke_senti"],
                brand_pos["sent_toke_senti"],
                ]
