...
class topic_classification:
    ...
    def __init__(self):
        ...
        self.topic_brand =   ["netbutik", "boozt", "virksomhed", "firma", "webshop", "hjemmeside", "onlin", "app",
                            "oplevelse", "anbefale", "anbefaling", "forretning"] # deleted "behandling" from here.
...
data['money_related'] = [find_topic.payment(i) for i in data['sent_toke_senti']]
data['delivery_service'] = [find_topic.delivery(i) for i in data['sent_toke_senti']]
data['return_service'] = [find_topic.returns(i) for i in data['sent_toke_senti']]
data['products'] = [find_topic.products(i) for i in data['sent_toke_senti']]
data['customer_service'] = [find_topic.service(i) for i in data['sent_toke_senti']]
data['brand'] = [find_topic.brand(i) for i in data['sent_toke_senti']]
...
data.to_csv("topic_categorized_reviews.csv")
